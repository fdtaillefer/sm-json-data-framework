...
namespace sm_json_data_framework.Models.Navigation
{
    ...
    public class UnlockNodeAction : AbstractNavigationAction
    {
        ...
        public UnlockNodeAction(string intent, UnfinalizedSuperMetroidModel model, ReadOnlyUnfinalizedInGameState initialInGameState, UnfinalizedExecutionResult executionResult) :
