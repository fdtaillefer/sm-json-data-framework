...
namespace sm_json_data_framework.Models.InGameStates
{
    ...
    /// An instance of this class is not intended to be moved from node to node, but should be replaced instead.
    /// </summary>
    public class UnfinalizedInNodeState : ReadOnlyUnfinalizedInNodeState
    {
        ...
        public UnfinalizedInNodeState(UnfinalizedRoomNode node)
        {
            Node = node;
        }

        public UnfinalizedInNodeState(UnfinalizedInNodeState other)
        {
            Node = other.Node;
        ...
        public UnfinalizedInNodeState Clone()
        {
            return new UnfinalizedInNodeState(this);
        }

        public UnfinalizedInNodeState AsReadOnly()
        {
            return this;
        }
    ...
    /// <summary>
    /// Exposes the read-only portion of an <see cref="UnfinalizedInNodeState"/>.
    /// </summary>
    public interface ReadOnlyUnfinalizedInNodeState
    {
        /// <summary>
        /// The node at which this InNodeState describes the situation.
        /// </summary>
